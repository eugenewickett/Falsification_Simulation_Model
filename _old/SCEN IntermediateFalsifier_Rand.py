...
scenarioStr = 'IntermediateFalsifier-Rand' # For file saving
...
# Change the supplier preference for first intermediate node (Node 2)
currIntermediate = List_IntermediateNode[0]
